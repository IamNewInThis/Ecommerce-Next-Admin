  ...
  return (
    <aside className="text-white p-4 pr-0">
      ...
      <nav className="flex flex-col gap-2">
        ...
        {/*Ordenes */}
        <Link className={pathname.includes('/ordenes') ? activeLink : inactiveLink} href={"/ordenes"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        {/*Configuracion */}
        <Link className={pathname.includes('/configuracion') ? activeLink : inactiveLink} href={"/configuracion"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
